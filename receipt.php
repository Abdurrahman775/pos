...
// Get transaction items (product_name is already stored in transaction_items)
$sql = "SELECT ti.*
    ...
    <style>
        @media print {
            @page {
                margin: 0;
                size: 80mm 100mm;
                /* Fixed size: 80mm width, 100mm height */
            }
...
<body>
    <div class="receipt">
        ...
        <div class="receipt-info">
            ...
            <div>
                <span>Date:</span>
                <span><?php echo date('d/m/Y H:i', strtotime($transaction['created_at'] ?? $transaction['transaction_date'])); ?></span>
            </div>
            ...
            <div>
                <span>Cashier:</span>
                <span><?php echo htmlspecialchars($transaction['cashier_name'] ?? 'System'); ?></span>
            </div>
            <div>
                <span>Payment:</span>
        ...
        <div class="totals">
            ...
            <?php if ($transaction['amount_paid'] > 0): ?>
                ...
                <div>
                    <span>Change:</span>
                    <span><?php echo $currency_symbol . number_format($transaction['change_amount'] ?? 0, 2); ?></span>
                </div>
            <?php endif; ?>
        </div>
