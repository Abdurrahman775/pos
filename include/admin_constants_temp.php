<?php
$admin = $_SESSION['pos_admin_temp'];
$name_format = "fms";

if((!isset($_SESSION['pos_admin_temp_basic'])) || (!is_array($_SESSION['pos_admin_temp_basic']))) {
	...
	$_SESSION['pos_admin_temp_basic'] = array();
	...
	$admin_fullname = $_SESSION['pos_admin_temp_basic']['fullname'] = strtoupper($fullname);
} else {
	$admin_fullname = $_SESSION['pos_admin_temp_basic']['fullname'];
}
?>